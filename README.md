...
| **Core-02** |Robot gets obstacle on its route| Robots gets any statioanary object in its scanning area | Robot should deviatses from its actual path and comes back to its originalo route once its pass through the object | - | Not executed |
